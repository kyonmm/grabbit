...
grails.spring.bean.packages = [ 'org.kyonmm.grabbit.aop' ]
...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'org.kyonmm.grabbit.SecureUser'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'org.kyonmm.grabbit.SecureUserSecureRole'
grails.plugin.springsecurity.authority.className = 'org.kyonmm.grabbit.SecureRole'
grails.plugin.springsecurity.failureHandler.useForward = true

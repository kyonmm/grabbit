  ...
  <div class="panel-body">
    ...
    <form role="form">
      ...
      <div class="form-group ${hasErrors(bean:testCaseInstance, field:'tags','has-error' )}">
        ...
        <g:select class="form-control" name="tags" from="${org.kyonmm.grabbit.Tag.list()}" multiple="multiple" optionKey="id" size="5" optionValue="name" value="${testCaseInstance?.tags?.name}"/>

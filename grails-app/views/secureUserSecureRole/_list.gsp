            ...
            <table class="table table-striped">
                ...
                <g:each in="${items}" status="i" var="secureUserSecureRoleInstance">
                    <tr>
                        ...
                        <td>
                            <g:remoteLink action="edit" id="${secureUserSecureRoleInstance.id}" update="form"
                                          method="GET" before="\$('.panel-heading').find('.loading').show()"
                                          onComplete="\$('.loading').hide();"><span class="label label-success"><span
                                    class="glyphicon glyphicon-eye-open"></span></span></g:remoteLink>
                            <g:remoteLink action="delete" id="${secureUserSecureRoleInstance.id}" update="content"

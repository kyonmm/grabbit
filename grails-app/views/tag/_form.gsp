  ...
  <div class="panel-body">
    ...
    <form role="form">
      ...
      <div class="form-group ${hasErrors(bean:tagInstance, field:'name','has-error' )}">
        ...
        <g:textArea class="form-control" placeholder="Enter Name" name="name"  cols="40" rows="2" maxlength="250" value="${tagInstance?.name}"/>
    ...
    <div class="form-group ${hasErrors(bean:tagInstance, field:'description','has-error' )}">
        ...
        <g:textArea class="form-control" placeholder="Enter Description" name="description" cols="40" rows="5" maxlength="1000" value="${tagInstance?.description}"/>

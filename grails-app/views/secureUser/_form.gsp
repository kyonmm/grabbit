  ...
  <div class="panel-body">
    ...
    <form role="form">
      ...
      <div class="form-group ${hasErrors(bean:secureUserInstance, field:'username','has-error' )}">
        ...
        <g:textField class="form-control" placeholder="Enter Username" name="username" required="" value="${secureUserInstance?.username}"/>
      ...
      <div class="form-group ${hasErrors(bean:secureUserInstance, field:'password','has-error' )}">
        ...
        <g:passwordField class="form-control" placeholder="Enter Password" name="password" required="" value="${secureUserInstance?.password}"/>
      ...
      <div class="form-group ${hasErrors(bean:secureUserInstance, field:'email','has-error' )}">
        ...
        <g:textField class="form-control" placeholder="Enter Email" name="email" required="" value="${secureUserInstance?.email}"/>

...
@Component
@Aspect
class SecureUserSecureRoleServiceList {

    @Pointcut(
        value='execution(java.util.Map org.kyonmm.grabbit.SecureUserSecureRoleService.list(..)) && bean(secureUserSecureRoleService) && args(params)',
        argNames='params')
